...
/**
 * Get_h2_included_in_body
 *
 * @param string $the_content the_content.
 * @return string
 **/
...
function add_widget_before_1st_h2( $the_content ) {
	if ( is_single() && is_active_sidebar( 'widget-in-article' ) ) {
		ob_start();
 ...
 * New Gravator
 *
 * @param array $avatar_defaults avatar_defaults.
 **/
function newgravatar( $avatar_defaults ) {
	$myavatar = 'https://lh4.googleusercontent.com/rDa29miI6l611YhBSRsSUxpCf0fDOjxbnaFkasUFdMoU3Ksap3_wSuOeMdzb7_ElewApYo2Hed2XqmM';
